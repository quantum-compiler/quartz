...
h q[33];
x psi[0];
cp(0.897557103427496) psi[0],q[0];
cp(1.795114206854992) psi[0],q[1];
cp(-2.6929568934696024) psi[0],q[2];
cp(0.8972715202403814) psi[0],q[3];
cp(1.7945430404807627) psi[0],q[4];
cp(-2.6940992262180607) psi[0],q[5];
cp(0.8949868547434644) psi[0],q[6];
cp(1.7899737094869288) psi[0],q[7];
cp(-2.7032378882057286) psi[0],q[8];
cp(0.8767095307681287) psi[0],q[9];
cp(1.7534190615362575) psi[0],q[10];
cp(-2.7763471841070713) psi[0],q[11];
cp(0.7304909389654439) psi[0],q[12];
cp(1.4609818779308879) psi[0],q[13];
cp(2.9219637558617757) psi[0],q[14];
cp(-0.43925779545603444) psi[0],q[15];
cp(-0.8785155909120689) psi[0],q[16];
cp(-1.7570311818241378) psi[0],q[17];
swap q[16],q[17];
cp(2.7691229435313107) psi[0],q[18];
swap q[15],q[18];
cp(-0.7449394201169645) psi[0],q[19];
swap q[14],q[19];
cp(-1.489878840233929) psi[0],q[20];
swap q[13],q[20];
cp(-2.979757680467858) psi[0],q[21];
swap q[12],q[21];
cp(0.3236699462438703) psi[0],q[22];
swap q[11],q[22];
cp(0.6473398924877406) psi[0],q[23];
swap q[10],q[23];
cp(1.2946797849754812) psi[0],q[24];
swap q[9],q[24];
cp(2.5893595699509624) psi[0],q[25];
swap q[8],q[25];
cp(-1.1044661672776617) psi[0],q[26];
swap q[7],q[26];
cp(-2.2089323345553233) psi[0],q[27];
swap q[6],q[27];
cp(1.8653206380689396) psi[0],q[28];
swap q[5],q[28];
