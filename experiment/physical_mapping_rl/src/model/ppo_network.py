...
class ValueNetwork(nn.Module):
    def __init__(self,
        ...
        hidden_dim1 = pow(2, math.ceil(math.log2(register_embedding_dimension / 3)))
        hidden_dim2 = pow(2, math.ceil(math.log2(register_embedding_dimension / 5)))
        hidden_dim3 = pow(2, math.ceil(math.log2(register_embedding_dimension / 11)))
    ...
    def forward(self, register_embeddings):
        ...
        """
        state_embedding = torch.sum(register_embeddings, dim=0)
...
def PolicyNetworkSimple(attention_score, action_space):
