...
class Generator {
 public:
  ...
  //   - When a gate uses more than one fresh new qubits or fresh new input
  //     parameters, restrict the order (for example, if a CX gate uses two
  //     fresh new qubits, the control qubit must have the smaller index).
