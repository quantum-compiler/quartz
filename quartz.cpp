...
extern "C" int preprocess_ (const char* cqasm_, char* buffer, int buff_size) {
  ...
  Context src_ctx({GateType::h, GateType::ccz, GateType::rz, GateType::rx, GateType::x, GateType::cx,
  ...
  Context rem_ctx({GateType::rx, GateType::h, GateType::x, GateType::rz, GateType::add,
                   GateType::cx, GateType::input_qubit, GateType::input_param});
