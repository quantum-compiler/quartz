...
class EquivalenceSet {
 public:
   ...
   * @param new_representatives If this variable is nullptr (default),
   * the file should be generated by |save_json()|, and this function will
   * load the parameter information to the context.
   * If this variable is not nullptr, this is an intermediate step in RepGen,
   * and the parameter information of the context will not be changed;
