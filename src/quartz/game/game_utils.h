...
namespace quartz {
    ...
    void set_initial_mapping(Graph &graph) {
        // a list of initial mappings to choose from, generated by initial mapping finder
        std::vector<std::vector<int>> logical2physical =
                {{22, 25, 23, 18, 14, 19, 12, 15, 21, 24, 13, 10, 11, 16, 8, 0, 1, 2, 3, 4, 5, 6, 7, 9, 17, 20, 26},
                 ...
                 {23, 5, 16, 13, 15, 21, 12, 14, 11, 8, 10, 19, 7, 18, 9, 0, 1, 2, 3, 4, 6, 17, 20, 24, 25, 22, 26},
                 {24, 5, 16, 13, 15, 21, 12, 14, 11, 8, 10, 19, 7, 18, 9, 0, 1, 2, 3, 4, 6, 17, 20, 23, 25, 22, 26},
                 {23, 5, 16, 13, 15, 21, 12, 14, 11, 8, 10, 19, 7, 18, 9, 0, 1, 2, 3, 4, 6, 17, 20, 24, 25, 22, 26},
