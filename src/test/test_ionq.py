...
if __name__ == '__main__':
    ...
    context = quartz.QuartzContext(
        gate_set=['rx1', 'x', 'rx3', 'ry1', 'y', 'ry3', 'rxx1', 'rxx3', 'rz', 'add'],
        filename='../../experiment/ecc_set/ionq_4_ecc.json',
        no_increase=False,
        include_nop=True,
    )
    circ = quartz.PyGraph.from_qasm(
        context=context, filename=f"../../experiment/ionq_circs/{circ_name}.qasm"
    )
