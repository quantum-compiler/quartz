...
int main() {
	...
	std::cout
	    << std::dec
	    << "Test phase shift with BFS verified: " << dataset.num_total_dags()
	...
	equiv_set.clear();
	system(
	    "python src/python/verifier/verify_equivalences.py "
	...
	std::cout
	    << std::dec << "Test phase shift with BFS verified: there are "
