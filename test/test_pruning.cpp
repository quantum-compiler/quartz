...
//                GateType::add}, "ibmq_no_u3_222_speed_", 2, 2, 2, 1, true, false);
//  test_pruning({GateType::u1, GateType::u2, GateType::cx,
//                GateType::add}, "ibmq_no_u3_233_", 2, 3, 3, 1, false, true);
//  test_pruning({GateType::u1, GateType::u2, GateType::cx,
//                GateType::add}, "ibmq_no_u3_223_speed_", 2, 2, 3, 1, true, false);
//  test_pruning({GateType::u1, GateType::u2, GateType::cx,
//                GateType::add}, "ibmq_no_u3_224_speed_", 2, 2, 4, 1, true, false);
